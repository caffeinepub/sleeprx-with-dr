...
const products = [
  ...
  },
  {
    ...
    description:
      "A highly-moisturizing, reparative conditioner that rebuilds broken hair bonds with every wash. Olaplex No. 5 leaves hair stronger, softer, and easier to manage while preventing frizz and split ends. Color-safe and suitable for all hair types — a salon staple at home.",
    coupon: null,
  },
  {
